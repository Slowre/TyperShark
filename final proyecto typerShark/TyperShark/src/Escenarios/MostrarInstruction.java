...
/**
 * Clase MostrarInstruction posee la imagenes y comentarions necesarios para entender el juego
 *
...
public class MostrarInstruction {
    ...
    Text stage = new Text();
    /**
     * Constructor de la clase MostrarInstruction
     *
     * inicializa un panel
     */
    ...
    /**
     * Metodo inicio Hace arrancar los paneles para mostrar laas instrucciones al jugador
     */
    public void Inicio() {
   ...
   /**
     * Metodo getRoot
     *
     * @return el panel GridPane de esta clase
     */
   ...
   /**
     * Metodo getState 
     *
     * @return el estado de esta ventana
     */
   ...
   /**
     * Metodo setState
     *
     * @param state setea el estado de esta ventana 
     */
