...
/**
 * Clase Piraña es hijo de un animal
 *
...
public class Piraña extends Animal {
     ...
     * @param palabra
     */
    public Piraña(Image imagen, Pane layer, double x, double y, int vidas, double speed, ArrayList<String> palabra) {
        ...
        this.palabra.getPane().relocate(x + (this.getHeight() * 0.25 / 2), y + (this.getWidth() * 0.25 / 4));
    }
